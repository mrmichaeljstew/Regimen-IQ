...
const collections = [
  {
    ...
    attributes: [
      ...
      { key: "careTeam", type: "string", size: 10000, required: false, array: true },
  ...
  },
  {
    ...
    attributes: [
      ...
      { key: "importance", type: "string", size: 20, required: false, default: "Medium" },
      { key: "sources", type: "string", size: 10000, required: false, array: true },
  ...
  },
  {
    ...
    attributes: [
      ...
      { key: "doctorName", type: "string", size: 255, required: false },
      { key: "appointmentType", type: "string", size: 100, required: false },
